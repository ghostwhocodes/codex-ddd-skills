...
The `grill-me` and `grill-with-docs` skills, and grilling sessions inside other skills, do not enforce a maximum number of questions. Requests to add a configurable cap or hard ceiling are out of scope.
