# Verify/Check Mode for `setup-project-context`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-project-context`.
